...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of URLTabNavigationController."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/URLTabNavigationController"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "liujianping" => "liujianping.itech@qq.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/URLTabNavigationController.git", :tag => s.version.to_s }
