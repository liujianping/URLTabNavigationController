...
@implementation NSURL (URLQueryDictionary)
...
@implementation NSString (URLQueryDictionary)
...
@implementation NSDictionary (URLQueryDictionary)
...
static inline NSString *URLEscape(NSString *string) {
    //    return [string stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet ]];
